...
const Index = ({ projects, customers }) => {
    ...
    const totals = useMemo(() => {
        ...
        const totalBayarPajak = projects.data
    ...
    const footerColumns = [
        ...
        { key: 'totalBayarPajak', label: 'Total PPH' },
    ...
    return (
        <Card>
            ...
            {showUangMasukModal && (
                <UangMasuk
                    showModal={showUangMasukModal}
                    setShowModal={setShowUangMasukModal}
                    projects={projects.data}
                />
            )}
            {showUangKeluarModal && (
                <UangKeluar
                    showModal={showUangKeluarModal}
                    setShowModal={setShowUangKeluarModal}
                    projects={projects.data}
                />
            )}
        </Card>
