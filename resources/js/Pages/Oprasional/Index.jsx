...
const Index = ({ oprasionals }) => {
    ...
    const filteredOperasional = oprasionals.data.filter(operasional =>
    ...
    return (
        <Card>
            ...
            <Card.CardBody>
                ...
                />
                <Table columns={columns} rows={filteredOperasional.slice(0, entriesPerPage)} footer={totals} footerColumns={footerColumns} />
