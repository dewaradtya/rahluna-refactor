...
const Update = ({ showModal, setShowModal, debtDetail }) => {
    const { data, setData, post, processing, errors, recentlySuccessful } = useForm({
        date: debtDetail.date || today(),
        description: debtDetail.description || '',
        amount: debtDetail.amount || 0,
        proof: null,
        _method: 'put'
    });
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(`/hutang/detail/${debtDetail.id}`, {
            preserveScroll: true
        });
    };
    ...
    return (
        <Modal title="Edit Bayar Hutang" showModal={showModal} setShowModal={setShowModal}>
            <Modal.Body>
