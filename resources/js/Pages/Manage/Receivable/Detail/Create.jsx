...
const Create = ({ showModal, setShowModal, receivableId }) => {
    const { data, setData, post, processing, errors, recentlySuccessful } = useForm({
        oprasional_id: receivableId,
        date: today(),
        description: '',
        amount: 0,
        proof: null
    ...
    return (
        <Modal title="Tambah Bayar Piutang" showModal={showModal} setShowModal={setShowModal}>
            <Modal.Body>
